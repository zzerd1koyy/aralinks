        ...
        <div class="box">
            ...
            <form action="validate.php" method="POST">
                <div class="form-group">
                    ...
                    <input type="text" id="code" name="code" placeholder="Enter your voucher code" required autofocus
                        maxlength="20" pattern="[A-Za-z0-9]{5,20}" title="Code should be 5-20 alphanumeric characters">
                </div>
