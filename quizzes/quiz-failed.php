...
$total = isset($_GET['total']) ? htmlspecialchars($_GET['total']) : '5';
$required = isset($_GET['required']) ? htmlspecialchars($_GET['required']) : '4';
$reason = isset($_GET['reason']) ? htmlspecialchars($_GET['reason']) : 'failed';

// Validate numeric values
if (!is_numeric($score)) $score = 0;
if (!is_numeric($total)) $total = 5;
if (!is_numeric($required)) $required = 4;

$percentage = floor(($score / $total) * 100);
?>
    ...
    <div class="result-box <?php echo $reason === 'duplicate' ? 'duplicate' : 'failed'; ?>">
        ...
        <?php if ($reason === 'duplicate'): ?>
            ...
            <div class="duplicate-message">
                ...
                <p>Each IP address is limited to <strong>1 free quiz access per day</strong> to ensure fair distribution of resources.</p>
            </div>
        ...
        <?php else: ?>
            ...
            <h1>Quiz Not Passed</h1>
            
            <div class="score-display">Your Score: <?php echo $score; ?>/<?php echo $total; ?> (<?php echo $percentage; ?>%)</div>
            ...
            <div class="feedback">
                ...
                <ul>
                    ...
                    <li>Required to pass: <strong><?php echo $required; ?> out of <?php echo $total; ?></strong></li>
                    <li>You need: <strong><?php echo max(0, $required - $score); ?> more correct answers</strong></li>
                </ul>
            </div>
            ...
            <div class="suggestions">
                ...
                <ul>
                    ...
                    <li>Review the topics before trying again</li>
                </ul>
            </div>
        <?php endif; ?>
