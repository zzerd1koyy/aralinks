...
-- Create Database
CREATE DATABASE
IF NOT EXISTS aralinks CHARACTER
SET utf8mb4
...
(
  ...
  device_ip VARCHAR
(45) NOT NULL COMMENT 'Student device IP address',
  device_mac VARCHAR
(17) COMMENT 'Student device MAC address',
  access_type ENUM
('quiz', 'voucher') DEFAULT 'quiz' COMMENT 'How access was gained',
  ...
  last_access TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON
UPDATE CURRENT_TIMESTAMP COMMENT 'When access was granted',
...
(
  id INT AUTO_INCREMENT PRIMARY KEY,
  code VARCHAR
(20) UNIQUE NOT NULL COMMENT 'Unique voucher code',
  ...
  used_by_ip VARCHAR
(45) COMMENT 'IP that used this voucher',
...
(
  ...
  level VARCHAR
(20) COMMENT 'Log level: INFO, WARNING, ERROR, SECURITY',
  ip_address VARCHAR
(45),
  action VARCHAR
(100),
...
SELECT code, duration, used, created_at
FROM vouchers;
